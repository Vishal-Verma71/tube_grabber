...
#         # Input for selecting video from search results
#         index = st.number_input("Enter choice (index) of video:", min_value=1, max_value=len(data), value=1, step=1) - 1
#         link = data[index][0]
#         yt = YouTube(link)
